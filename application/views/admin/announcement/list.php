		...
		<section class="content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li class="active">Announcement - Detail</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header">
							<h1 class="box-title">Announcement - Detail</h1>
							<a class="box_btn" href="<?php echo base_url()?>admin/announcement/add/"><button class="btn btn-primary only_float_right">Add New Announcement</button></a>
						</div>
						<div class="box-body">
	...
	<script type="text/javascript">
		function TempDel(id){
			bootbox.confirm("<h3>Are you sure, You want to delete this entry?</h3>", function(result){
				if(result){
					$.ajax({
						url : "<?php echo base_url()."admin/announcement/delete"?>",
						type : "POST",
						data : {"value" : id},
