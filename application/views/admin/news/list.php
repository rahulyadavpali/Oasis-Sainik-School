				...
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header">
							<h1 class="box-title">News - Detail</h1>
							<a class="box_btn" href="<?php echo base_url()?>admin/news/add/"><button class="btn btn-primary only_float_right">Add New News</button></a>
						</div>
						<div class="box-body">
