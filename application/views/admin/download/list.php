		...
		<section class="content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li class="active">Downloads - Detail</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header">
							<h1 class="box-title">Downloads - Detail</h1>
							<a class="box_btn" href="<?php echo base_url()?>admin/downloads/add/"><button class="btn btn-primary only_float_right">Add New Downloads</button></a>
						</div>
						<div class="box-body">
							<table id="sample-table-2" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?php echo $allresult[$key]['links']; ?>" target="_blank"><?php echo $allresult[$key]['links']; ?></a></td>
										<td>
	...
	<script type="text/javascript">
		function TempDel(id){
			bootbox.confirm("<h3>Are you sure, You want to delete this entry?</h3>", function(result){
				if(result){
					$.ajax({
						url : "<?php echo base_url()."admin/downloads/delete"?>",
						type : "POST",
						data : {"value" : id},
